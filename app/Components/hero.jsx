...
export default function Hero() {
    return (
        ...
        <div className="flex flex-col">
          <h1
            className={`${monoton.className} font-bold text-5xl lg:text-7xl text-slate-600`}
          >
            Password Generator
          </h1>
          ...
          <Link
          href="/info"
          className="border-[#FD735B] text-slate-600 hover:bg-[#FD735B] hover:text-white hover:shadow-md border-2 px-2 py-1 mt-4 rounded-lg duration-500 text-center w-[150px]"
        >
