...
export default function Open() {
  return (
    <main>
      <div className="flex bg-slate-100 p-10 rounded-lg justify-center items-center border gap-5 shadow">
        ...
        <div className="w-1/2 flex flex-col gap-4">
          ...
          <Link
            className="bg-indigo-500 hover:opacity-40 duration-300 w-fit px-4 py-2 rounded-full text-white mx-auto"
