    ...
    <main className="flex flex-col items-center justify-center max-w-6xl mx-auto p-10 sm:p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-7 mt-10">
        ...
        <div className="p-4 border rounded-lg bg-yellow-500 hover:shadow-lg duration-300 bg-opacity-40 flex flex-col gap-2 col-span-2">
          <span className="font-semibold">Unpredictability</span>
          <li>
        ...
        <div className="p-4 border rounded-lg bg-orange-500 hover:shadow-lg duration-300 bg-opacity-40 flex flex-col gap-2 sm:col-span-3 col-span-2">
          <span className="font-semibold">Examples of Strong Passwords</span>
          <li>
        ...
        <div className="p-4 border rounded-lg bg-lime-500 hover:shadow-lg duration-300 bg-opacity-40 flex flex-col gap-2 sm:col-span-1 col-span-2">
          <span className="font-semibold">Bad Practices to Avoid</span>
          <li>
        ...
        <div className="p-4 border rounded-lg bg-slate-200 hover:shadow-lg duration-300 bg-opacity-40 flex flex-col gap-2 sm:col-span-2 col-span-2">
          ...
          <Link
            className="text-blue-500 hover:opacity-40 duration-300 mr-auto my-2"
      ...
      <Link
        className="my-10 mr-auto bg-blue-500 hover:opacity-50 duration-400 px-4 py-2 text-white rounded"
        href="/"
      >
        &larr; Back
      </Link>
